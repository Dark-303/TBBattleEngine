...
import battleEngine.game.ModeController;
...
public class BattleEngine {
    ...
    public void setPlayerData() {
        ...
        playerData.setGeneralStats(100, 7);
        playerData.setEvade(1);
    ...
    public void setEnemyData() {
        ...
        enemyData.setUltimateMove("Fist", "Rose Thorns", 100.00, 90.00, 0.80, 0.5, 3);
