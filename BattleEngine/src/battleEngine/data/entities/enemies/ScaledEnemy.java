...
public class ScaledEnemy {
    ...
    // Constructor
    public ScaledEnemy(double multiplier) {
        ...
        enemyData = new EnemyData(100 * strengthMultiplier, 7 * strengthMultiplier, armor, primary, secondary, ultimate,
                1);
    }
}